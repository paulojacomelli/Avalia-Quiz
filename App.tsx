...
function App() {
  ...
  const handleGenerate = async (config: QuizConfig) => {
    ...
    setLoading(true);
    setLoadingMessage("Preparando a partida..."); // Initial message
    setErrorDetail(null);
    setQuizData(null);
                    ...
                    {usedTopics.length > 0 && (
                        <div className="bg-jw-card/50 p-6 rounded-xl border border-gray-700/30 animate-fade-in-up">
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-xs font-bold uppercase tracking-widest text-gray-500">Últimos Temas de Quiz</h3>
                                <button 
